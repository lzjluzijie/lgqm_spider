...
# -*- encoding: utf-8 -*-
'''
@File    :   ximalaya_downloader.py
@Time    :   2019/08/21 23:33:31
@Author  :   Jeffrey Wang
@Version :   1.0
@Contact :   shwangjj@163.com
@Desc    :   从github上下载的喜马拉雅音频下载程序，亲测可用
'''
...
def download(name,download_url,list_index):
    file_name = 'C:\\foo\\x_download\\' + name + '.mp3'
    #print(file_name)
...
windows.title('XMLY Downloader Sunic ')
